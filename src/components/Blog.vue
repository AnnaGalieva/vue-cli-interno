<template><div class="box-content"> <main class="main">
                ...
                <nav class="blog__info__heading_breadcrumb">
                    <ul class="blog__info__heading_breadcrumb_ul">
                        <li class="blog__info__heading_breadcrumb_li">
                            <a class="blog__info__heading_breadcrumb_link" href="">Home</a>
                        </li>
                        <li class="blog__info__heading_breadcrumb_li">
                            <a class="blog__info__heading_breadcrumb_link" href="">Blog</a>
                        </li>
                    </ul>
                </nav>
            </div>
    ...
    <section class="post center">
        ...
        <div class="post__content">
            ...
            <div class="post__content_info">
                ...
                <p class="post__content_info_text">Lorem ipsum dolor sit amet, adipiscing Aliquam eu sem vitae turpis
                    dignissim maximus.posuere in.Contrary to popular belief.</p>
                <p class="post__content_info_text"> Lorem Ipsum is not simply random text. It has roots in a piece of
                    classica.</p>
                <div class="post__content_info_min">
                    <p class="post__content_info_min_text">26 December,2022 </p>
                    <div class="post__content_info_min_button"><button class="post__content_info_min_btn"><svg
                ...
                <div class="articles__all_item_content">
                    ...
                    <div class="articles__all_item_content_contentmin">
                        ...
                        <div class="articles__all_item_content_button">
                            <a href="blog_details.html" class="articles__all_item_content_btn"><svg
                                    xmlns="http://www.w3.org/2000/svg" width="52" height="53" viewBox="0 0 52 53"
                                    fill="none">
